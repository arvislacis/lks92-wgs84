var LKS92WGS84 = (function () {
    ...
    LKS92WGS84.convertMapLatLngToXY = function (phi, lambda, lambda0) {
        var N, nu2, ep2, t, t2, l, l3coef, l4coef, l5coef, l6coef, l7coef, l8coef, xy = [0, 0];
    ...
    LKS92WGS84.convertMapXYToLatLon = function (x, y, lambda0) {
        var phif, Nf, Nfpow, nuf2, ep2, tf, tf2, tf4, cf, x1frac, x2frac, x3frac, x4frac, x5frac, x6frac, x7frac, x8frac, x2poly, x3poly, x4poly, x5poly, x6poly, x7poly, x8poly, latLng = [0, 0];
    ...
    LKS92WGS84.convertLatLonToXY = function (coordinates) {
        var lat = coordinates[0] * LKS92WGS84.PI / 180, lng = coordinates[1] * LKS92WGS84.PI / 180, xy = LKS92WGS84.convertMapLatLngToXY(lat, lng, LKS92WGS84.CENTRAL_MERIDIAN);
    ...
    LKS92WGS84.convertXYToLatLon = function (coordinates) {
        var x = (coordinates[0] - LKS92WGS84.OFFSET_X) / LKS92WGS84.SCALE, y = (coordinates[1] - LKS92WGS84.OFFSET_Y) / LKS92WGS84.SCALE, latLng = LKS92WGS84.convertMapXYToLatLon(x, y, LKS92WGS84.CENTRAL_MERIDIAN);
...
//# sourceMappingURL=LKS92WGS84.js.map